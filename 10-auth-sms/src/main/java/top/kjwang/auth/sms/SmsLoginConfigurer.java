...
public final class SmsLoginConfigurer<H extends HttpSecurityBuilder<H>> extends AbstractAuthenticationFilterConfigurer<H, SmsLoginConfigurer<H>, SmsAuthenticationFilter> {
	...
	public void configure(H http) throws Exception {
		...
		UserDetailsServiceImpl userDetailsService = http.getSharedObject(ApplicationContext.class).getBean(UserDetailsServiceImpl.class);
		...
		http.authenticationProvider(new SmsAuthenticationProvider(userDetailsService, stringRedisTemplate));
		// 设置过滤器
	...
	public void smsCodeParameter(String smsCodeParameter) {
