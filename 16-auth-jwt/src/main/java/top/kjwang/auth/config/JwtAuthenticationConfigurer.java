...
import top.kjwang.auth.jwt.JwtTokenSecurityContextHolderFilter;
import top.kjwang.auth.resolver.BearerTokenResolver;
import top.kjwang.auth.resolver.DefaultBearerJwtTokenResolver;

/**
 * @author kjwang
 * @date 2023/8/1 10:13
 * @description JwtAuthenticationConfigurer
 */
