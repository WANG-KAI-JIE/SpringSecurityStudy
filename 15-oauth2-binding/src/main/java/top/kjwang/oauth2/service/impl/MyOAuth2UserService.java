 ...
 * @author kjwang
 * @date 2023/7/31
 * @description MyOAuth2UserService
 **/
@Service
public class MyOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public MyOAuth2UserService(IUserBindThirdLoginService bindThirdLoginService, IUserService userService) {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if (!StringUtils.hasText(userRequest.getClientRegistration().getProviderDetails().getUserInfoEndpoint().getUri())) {
            ...
            if (!StringUtils.hasText(userIdAttributeName)) {
                ...
                // 8. 返回UserDetails类型用户
                return new MyUserDetails(user.getUserId(), thirdUserId, null, user.getUserName(), user.getPhone(), authorityList,
