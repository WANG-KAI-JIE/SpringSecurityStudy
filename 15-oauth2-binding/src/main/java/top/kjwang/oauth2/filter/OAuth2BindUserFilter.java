package top.kjwang.oauth2.filter;
...
import top.kjwang.oauth2.utils.OAuth2AuthorizationUtils;
 ...
 * @author kjwang
 * @date 2023/7/31
 * @description OAuth2BindUserFilter
 **/
public class OAuth2BindUserFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        if (!this.requiresAuthentication(request, response)) {
            ...
            MultiValueMap<String, String> params = OAuth2AuthorizationUtils.toMultiMap(request.getParameterMap());
            if (!OAuth2AuthorizationUtils.isAuthorizationResponse(params)) {
                ...
                if (authorizationRequest == null) {
                    ...
                    if (clientRegistration == null) {
                        ...
                        OAuth2AuthorizationResponse authorizationResponse = OAuth2AuthorizationUtils.convert(params, redirectUri);
